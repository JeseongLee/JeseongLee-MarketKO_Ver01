...
CREATE TABLE PRODUCT_OPTION(
	...
	CONSTRAINT FK_PN_P_O FOREIGN KEY(PRODUCT_NUMBER) REFERENCES PRODUCT_INFO(PRODUCT_NUMBER),
...
CREATE TABLE DEAL_BOARD(
	...
	DEAL_BOARD_HIT VARCHAR2(100) NOT NULL,
	DEAL_BOARD_BLOCK_STATE NUMBER DEFAULT 0 NOT NULL, -- 블록 여부, 0이면 기본 글, 1이면 블록 처리
...
CREATE TABLE PRODUCT_IMG(
	...
	CONSTRAINT FK_PN_P_IMG FOREIGN KEY(PRODUCT_NUMBER) REFERENCES PRODUCT_INFO(PRODUCT_NUMBER)
);
...
CREATE TABLE EVALUATION(
	...
	EVALUATION_BLOCK_STATE NUMBER DEFAULT 0 NOT NULL, -- 블록 여부, 0이면 기본 글, 1이면 블록 처리
